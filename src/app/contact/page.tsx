      ...
      <div className="container mx-auto px-4 py-32">
        ...
        <div className="grid lg:grid-cols-2 gap-8 items-stretch">
          ...
          <div className="space-y-8 h-full flex flex-col">
            {/* Gambar Contact */}
            <div
              className={`relative rounded-2xl overflow-hidden shadow-2xl ${anim.fadeInUp}`}
            ...
            {/* Info Kontak */}
            <div
              className={`bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 space-y-6 flex-1 ${anim.fadeInUp}`}
            ...
            >
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-green-100">orang@terralytics.utpas.id</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <form
            ...
            className={`bg-white/20 backdrop-blur-lg border border-white/30 rounded-2xl p-8 shadow-xl h-full flex flex-col justify-between ${anim.fadeInUp}`}
          ...
          >
            <div className="space-y-6">
              ...
              {/* Tombol */}
              <div
                className={`flex flex-col sm:flex-row gap-4 pt-4 ${anim.fadeInUp}`}
