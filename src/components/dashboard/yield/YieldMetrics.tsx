    ...
    <div>
      ...
      <div className="flex justify-between items-center mb-4">
        <div className="flex flex-col items-center bg-[#222]/80 rounded-xl p-4 w-1/2 mr-2">
          ...
          <p className="text-xs">ton/hektar</p>
          <p className="text-sm text-green-400">Hasil Saat Ini</p>
        </div>
        <div className="flex flex-col items-center bg-[#222]/80 rounded-xl p-4 w-1/2 ml-2">
          <p className="text-2xl font-bold">7.8</p>
          <p className="text-xs">ton/hektar</p>
          <p className="text-sm text-yellow-400">Potensi Hasil</p>
        </div>
      </div>

      <div className="space-y-3">
        <div>
          <p className="text-xs">Efisiensi</p>
